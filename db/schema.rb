...
ActiveRecord::Schema[8.0].define(version: 2025_06_01_104859) do
  ...
  create_table "answers", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["lawyer_id", "status"], name: "index_answers_on_lawyer_id_and_status"
  ...
  create_table "payments", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["answer_id", "status"], name: "index_payments_on_answer_id_and_status"
